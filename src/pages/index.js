...
import lb from "../../public/images/svgs/miscellaneous_icons_1.svg";
...
export default function Home() {
  return (
    <>
      ...
      <TransitionsEffect />
      <main className="flex items-center text-dark w-full min-h-scree dark:text-light">
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
          <Image src={lb} alt="MKJ" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
